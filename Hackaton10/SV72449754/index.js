...
// crud("sample_mflix","movies","leerUno",opciones).then((res) => {
//     console.log(res)
// });
let data = {
...
// crud("sample_mflix", "movies", "actualizarUno", filtro, data2).then((res) => {
//     console.log(res)
// });

let filtro2 = { year: 1925 }

// crud("sample_mflix", "movies", "borrarUno", filtro2).then((res) => {
//     console.log(res)
// });

/* --------OPCIONES DE LA FUNCION ----------------

    function crud(base, coleccion, accion, filtro = null, data = null)
...
crud("sample_mflix", "movies", "leerTodos").then((res) => {
    console.log(res)
});